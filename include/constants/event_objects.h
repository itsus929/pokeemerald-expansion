...
enum
{
    PLAYER_APPEARANCE_BRENDAN,
    PLAYER_APPEARANCE_MAY,
    PLAYER_APPEARANCE_JUSTIN,
    PLAYER_APPEARANCE_MAAM,
    PLAYER_APPEARANCE_SIR,
    PLAYER_APPEARANCE_LEXY,
};
...
enum
{
    ...
    OBJ_EVENT_GFX_JUSTIN_NORMAL,
    OBJ_EVENT_GFX_JUSTIN_MACH_BIKE,
    OBJ_EVENT_GFX_JUSTIN_ACRO_BIKE,
    OBJ_EVENT_GFX_JUSTIN_SURFING,
    OBJ_EVENT_GFX_JUSTIN_UNDERWATER,
    OBJ_EVENT_GFX_JUSTIN_FIELD_MOVE,
    OBJ_EVENT_GFX_JUSTIN_FISHING,
    OBJ_EVENT_GFX_JUSTIN_WATERING,
    OBJ_EVENT_GFX_JUSTIN_DECORATING,
    OBJ_EVENT_GFX_LEXY_NORMAL,
    OBJ_EVENT_GFX_LEXY_MACH_BIKE,
    OBJ_EVENT_GFX_LEXY_ACRO_BIKE,
    OBJ_EVENT_GFX_LEXY_SURFING,
    OBJ_EVENT_GFX_LEXY_UNDERWATER,
    OBJ_EVENT_GFX_LEXY_FIELD_MOVE,
    OBJ_EVENT_GFX_LEXY_FISHING,
    OBJ_EVENT_GFX_LEXY_WATERING,
    OBJ_EVENT_GFX_LEXY_DECORATING,
    OBJ_EVENT_GFX_MAAM_NORMAL,
    OBJ_EVENT_GFX_MAAM_MACH_BIKE,
    OBJ_EVENT_GFX_MAAM_ACRO_BIKE,
    OBJ_EVENT_GFX_MAAM_SURFING,
    OBJ_EVENT_GFX_MAAM_UNDERWATER,
    OBJ_EVENT_GFX_MAAM_FIELD_MOVE,
    OBJ_EVENT_GFX_MAAM_FISHING,
    OBJ_EVENT_GFX_MAAM_WATERING,
    OBJ_EVENT_GFX_MAAM_DECORATING,
    OBJ_EVENT_GFX_SIR_NORMAL,
    OBJ_EVENT_GFX_SIR_MACH_BIKE,
    OBJ_EVENT_GFX_SIR_ACRO_BIKE,
    OBJ_EVENT_GFX_SIR_SURFING,
    OBJ_EVENT_GFX_SIR_UNDERWATER,
    OBJ_EVENT_GFX_SIR_FIELD_MOVE,
    OBJ_EVENT_GFX_SIR_FISHING,
...
#define OBJ_EVENT_PAL_TAG_JUSTIN                  0x1134
#define OBJ_EVENT_PAL_TAG_LEXY                    0x1135
